...
ssl_certificate /etc/letsencrypt/live/xxxxxx.$opt/fullchain.pem; # managed by Certbot
ssl_certificate_key /etc/letsencrypt/live/xxxxxx.$opt/privkey.pem; # managed by Certbot
}
