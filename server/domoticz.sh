...
# 3) apt-get install curl -y && curl https://raw.githubusercontent.com/Meek-HA/Meek-io/server/master/domoticz.sh --output domoticz.sh && chmod +rwx domoticz.sh && ./domoticz.sh
