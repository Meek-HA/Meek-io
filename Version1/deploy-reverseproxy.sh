...
# curl https://raw.githubusercontent.com/Meek-HA/Meek-io/master/Version1/deploy-reverseproxy.sh --output deploy-reverseproxy.sh && chmod +rwx deploy-reverseproxy.sh && ./deploy-reverseproxy.sh
# xxxxxx = Full domain
# zzzzzz = IP container
